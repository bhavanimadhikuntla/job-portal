...
export const getCandidateProfile = (userId) => {
    return axios.get(`${API_URL}/candidate-profile/${userId}`);
};
...
export const createJob = (data) => {
    return axios.post(`${API_URL}/jobs/create`, data);
};
...
export const updateJob = (jobId, data) => {
    return axios.put(`${API_URL}/jobs/${jobId}`, data);
};
...
export const applyJob = (data) => {
    return axios.post(`${API_URL}/applyCandidate`, data);
};
...
export const getAppliedJobs = (userId) => {
    return axios.get(`${API_URL}/appliedJobs/${userId}`);
};
